...
if (!isset ($tagFace['description_pages'])) $tagFace['description_pages'] = "";
if($config['version_id'] < 9.6)
{
echo <<<HTML
<tr id="description_pages_line">
	<td valign="top" style="padding:2px;">Описание для остальных страниц:</td>
...
$(function(){
    ...
    <textarea name="description_pages" id="description_pages" style="width:98%;height:300px;">{$tagFace['description_pages']}</textarea></td></tr>
HTML;
}
...
function tag_typograf() {
    ...
    <textarea name="description_pages" id="description_pages" class="wysiwygeditor" style="width:98%;height:300px;">{$tagFace['description_pages']}</textarea></td></tr>
HTML;
}
