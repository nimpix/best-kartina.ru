...
<div style="padding:5px;"><input onClick="savefile('{$file_path}/{$file_name}')" type="button" class="btn btn-success btn-small" value="{$lang['user_save']}" style="width:100px;">&nbsp;<input onClick="autoFormatSelection();" type="button" class="btn btn-primary btn-small" value="{$lang['format_template']}" style="width:220px;"></div>
{$script}
HTML;
