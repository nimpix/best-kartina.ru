...
$result_title = "В жопу себе ссылку засунь ХУЙЛО!!!";
...
$result_title = "Оставьте ваш отзыв о сайте";
$result = <<<HTML
...
<p>
		<label>Телефон с которого был оформлен заказ:</label>
		<input type="text" maxlength="45" name="phone">
</p>
<p>
		<label>Ссылка на вашу страницу vk.com:</label>
...
<input class="submit-review" type="submit" value="оставить отзыв">
</form>
