...
echo <<<HTML
	...
	<textarea rows=17 style="width:98%;" onfocus="setFieldName(this.name)" name="message" id="message" class="bk"></textarea><br><br>{$lang['nl_info_1']} <b>{$lang['nl_info_2']}</b><script type=text/javascript>var selField  = "message";</script></td>
	</tr></table>
</td></tr>
HTML;
}
