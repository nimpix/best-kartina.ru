    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                closeBtn: '<a title="Close" id="closeit" class="fancybox-item fancybox-close" href="javascript:;"></a>',
        ...
        _afterZoomIn: function() {
            ...
            a && (b.isOpen = b.isOpened = !0, b.wrap.css("overflow", "visible").addClass("fancybox-opened"), b.update(), (a.closeClick || a.nextClick && 1 < b.group.length) && b.inner.css("cursor", "pointer").bind("click.fb", function(d) {
                !f(d.target).is("a") && !f(d.target).parent().is("a") &&
				   ...
				   $(".sliderkit_view").fadeOut("slow");
				   jQuery("div.img_leftside div#newId").attr("id","full-gallery");
				   jQuery("div.right_side_imgs div#newId").attr("id","full-gallery");
...
(function(e) {
    ...
    d.helpers.buttons = {
        ...
        onUpdate: function(c, a) {
            var b;
            this.buttons && (b = this.buttons.toggle.removeClass("btnDisabled btnToggleOn"),
                a.canShrink ? b.addClass("btnToggleOn") : a.canExpand || b.addClass("btnDisabled"))
        },
    ...
    d.fancybox.helpers.thumbs = {
        ...
        init: function(b, a) {
            var j = this,
                ...
                k = b.source;
            c = "";
            for (var e = 0; e < a.group.length; e++) c += '<li><a style="width:' + g + "px;height:" + f + 'px;" href="javascript:jQuery.fancybox.jumpto(' + e + ');"></a></li>';
            ...
            d.each(a.group, function(b) {
                ...
                c && d("<img />").load(function() {
                    var a = this.width,
                        c = this.height,
                        h, i, e;
                    j.list && (a && c) && (h = a / g, i = c / f, e = j.list.children().eq(b).find("a"), 1 <= h && 1 <= i && (h > i ? (a = Math.floor(a / i), c = f) : (a = g, c = Math.floor(c / h))), d(this).css({
                        width: a,
                        height: c,
                        top: Math.floor(f / 2 - c / 2),
                        left: 0
                    }), e.width(g).height(f), d(this).hide().appendTo(e).fadeIn(300))
                }).attr("src", c)
            });
            this.width = this.list.children().eq(0).outerWidth(!0);
            this.list.width(this.width *
                (a.group.length + 1)).css("left", Math.floor(0.5 * d(window).width() - (a.index * this.width + 0.5 * this.width)))
        },
        ...
        onUpdate: function(b, a) {
            this.list && this.list.stop(!0).animate({
                    left: Math.floor(0.5 * d(window).width() - (a.index * this.width + 0.5 * this.width))
                },
                150)
        },
        beforeClose: function() {
...
(function(d) {
    var j = function(a, c, b) {
        b = b || "";
        "object" === d.type(b) && (b = d.param(b, !0));
        d.each(c, function(b, c) {
            a = a.replace("$" + b, c || "")
        });
        b.length && (a += (0 < a.indexOf("?") ? "&" : "?") + b);
        return a
    };
    d.fancybox.helpers.media = {
        defaults: {
            youtube: {
            ...
            metacafe: {
                ...
                type: "swf",
                url: function(a, c, b) {
                    b.swf.flashVars = "playerVars=" + d.param(c, !0);
                    return "http://www.metacafe.com/fplayer/" + a[1] + "/.swf"
                }
            },
            dailymotion: {
            ...
            twitpic: {
                ...
                type: "image",
                url: "http://twitpic.com/show/full/$1/"
            },
            instagram: {
                matcher: /(instagr\.am|instagram\.com)\/p\/([a-zA-Z0-9_\-]+)\/?/i,
                type: "image",
                url: "http://$1/p/$2/media/"
            },
            google_maps: {
                matcher: /maps\.google\.([a-z]{2,3}(\.[a-z]{2})?)\/(\?ll=|maps\?)(.*)/i,
                type: "iframe",
                url: function(a) {
                    return "//maps.google." + a[1] + "/" + a[3] + "" + a[4] + "&output=" + (0 < a[4].indexOf("layer=c") ?
                        "svembed" : "embed")
                }
            }
        },
        beforeLoad: function(a, c) {
            var b = c.href || "",
                ...
                f, e, h;
            for (f in a)
                if (e = a[f], h = b.match(e.matcher)) {
                    g = e.type;
                    b = d.extend(!0, {}, e.params, c[f] || (d.isPlainObject(a[f]) ? a[f].params : null));
                    b = "function" === d.type(e.url) ? e.url.call(this, h, b, c) : j(e.url, h, b);
                    break
                }
            g && (c.href = b, c.type = g, c.autoHeight = !1)
        }
    }
})(jQuery);