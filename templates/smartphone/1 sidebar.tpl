       ...
       <ul class="sidebar_menu">
          ...
          <li[category=14] class="active"[/category]><a class="head" href="/postery/">Постеры</a></li>
          <li[category=9] class="active"[/category]><a class="head" href="/tehnika/">Техника</a></li>
          <li[category=15] class="active"[/category]><a class="head" href="/erotika-18/">Эротика 18+</a></li>
          <li[category=16] class="active"[/category]><a class="head" href="/sport/">Спорт</a></li>
          <li[category=17] class="active"[/category]><a class="head" href="/rybalka/">Рыбалка</a></li>
