...
<header>
	<div class="header">
		<div class="wrap clearfix">
			...
			<!-- priemushestva -->
			<div class="block_one">
				<div class="list">Огромный выбор!</div>
            	<div class="list">Модульных картин</div>
            	<div class="list">от лучшей мастерской России</div>
        	</div>
        	<div class="block_two">
            	<div class="list">Более 8000 картин в ассортименте</div>
            	<div class="list">Более 25000 счастливых клиентов</div>
            	<div class="list">Более 11 лет на рынке</div>
        	</div>
...
<script type="text/javascript">
    ...
    window._retag.push({code: "9ce88879da", level: 0});
    (function () {
...
[aviable=cat]
<script type="text/javascript">
    window.ad_category = {category-id};   // required

    window._retag = window._retag || [];
    window._retag.push({code: "9ce88879d9", level: 1});
    (function () {
        var id = "admitad-retag";
        if (document.getElementById(id)) {return;}
        var s=document.createElement("script");
