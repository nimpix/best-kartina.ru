<script type="text/javascript">
    $(window).load(function() {
		...
		$('.psa-options3').attr('value', 'Написать эту картину маслом - l');
		});
		
		$('#radio_xl').on('click', function() {
		$('.psa-options3').attr('data-value', '6000');
		$('.psa-options3').attr('value', 'Написать эту картину маслом - xl');
		});
		
		$('#radio_xxl').on('click', function() {
		$('.psa-options3').attr('data-value', '7000');
	...
	<div class="goods-item clearfix">
		<div class="goods-img gallery">
			...
			<div class="goods-price">
				<div class="psa-pricer">Новая цена: <div class="psa_order"><? echo [xfvalue_cena_m] + 300; ?></div> руб. </div>
				<div class="new_price psa_p" style="display:none;">Новая цена: <span><? echo [xfvalue_cena_m] + 300; ?></span> руб.</div>
				[xfgiven_cena_m_old]
		...
		<div class="goods-info">
			<div class="radio_btns">
				[xfgiven_cena_m]
				<div class="radio-item radio_m" data-value="<? echo [xfvalue_cena_m] + 300; ?>" data-old="[xfvalue_cena_m_old]" data-razmer="[xfvalue_razmer_m]">
				...
				[/xfgiven_cena_m]
				[xfgiven_cena_l]
				<div class="radio-item radio_l" data-value="<? echo [xfvalue_cena_l] + 500; ?>" data-old="[xfvalue_cena_l_old]" data-razmer="[xfvalue_razmer_l]">
				...
				[/xfgiven_cena_l]
				[xfgiven_cena_xl]
				<div class="radio-item radio_xl" data-value="<? echo [xfvalue_cena_xl] + 600; ?>" data-old="[xfvalue_cena_xl_old]" data-razmer="[xfvalue_razmer_xl]">
				...
				[/xfgiven_cena_xl]
				[xfgiven_cena_xxl]
				<div class="radio-item radio_xxl" data-value="<? echo [xfvalue_cena_xxl] + 700; ?>" data-old="[xfvalue_cena_xxl_old]" data-razmer="[xfvalue_razmer_xxl]">
					<input type="radio" id="radio_xxl" name="size">
					<label for="radio_xxl">
						[xfgiven_razmer_xxl]
						[xfvalue_razmer_xxl] см [xfgiven_gotov_xxl]<span class="send_soon">(отправим уже завтра)</span>[/xfgiven_gotov_xxl]
						[/xfgiven_razmer_xxl]
						[xfnotgiven_razmer_xxl]Размер не указан[/xfnotgiven_razmer_xxl]
					</label>
				</div>
				[/xfgiven_cena_xxl]
			</div>
...
<script type="text/javascript">
    ...
    window._retag.push({code: "9ce88879d8", level: 2});
    (function () {
