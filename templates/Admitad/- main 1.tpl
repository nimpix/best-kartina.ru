...
<div class="pop pop_up">
	...
	<form class="form-send form-callback" novalidate>
		<div class="input">
...
<div class="pop pop_order">
	...
	<form class="form-send form-order" novalidate>
		<div class="order-info clearfix">
			...
			<div class="order-text">
				...
				<p>Цена сейчас <span class="new_price"></span></p>
...
{include file="/engine/modules/chat_last.php"}
