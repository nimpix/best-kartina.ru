$(document).ready(function () {
  ...
  $('.btn-order, .btn-buy').on('click', function(e) {
    ...
    var $art = $parent.find('.hidden-art').val();
    ...
    $('.pop_order').find('.hidden-art').val($art);
  ...
  e.preventDefault();
  var ActionName=$(this).children('span').text();
  if (ActionName == 'Показать') {
  $("nav.left-menu").fadeIn();
  $(this).children('span').text('Скрыть');
  }
  else {
  $("nav.left-menu").fadeOut();
