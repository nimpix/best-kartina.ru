	...
	<div class="goods-item clearfix">
		...
		<div class="goods-info">
			<div class="radio_btns">
				...
				[/xfgiven_cena_xl]
				[xfgiven_cena_xxl]
				<div class="radio-item radio_xxl" data-value="[xfvalue_cena_xxl]" data-old="[xfvalue_cena_xxl_old]" data-razmer="[xfvalue_razmer_xxl]">
			...
			<div class="goods-price">
				...
				<input type="hidden" class="hidden-art" name="art" value="[xfvalue_art]">
